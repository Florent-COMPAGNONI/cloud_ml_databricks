...
# MAGIC - Compare trials in the [MLflow experiment](#mlflow/experiments/630618801102421).
...
input_data_path = mlflow.artifacts.download_artifacts(run_id="dcf01c9df50e4309b1675d07c733d043", artifact_path="data", dst_path=input_temp_dir)
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/630618801102421)
...
def objective(params):
  with mlflow.start_run(experiment_id="630618801102421") as mlflow_run:
...
space = {
  "colsample_bytree": 0.25950262092768267,
  "learning_rate": 0.02246957541945063,
  "max_depth": 5,
  "min_child_weight": 16,
  "n_estimators": 1331,
  "n_jobs": 100,
  "subsample": 0.547877612431211,
  "verbosity": 0,
  "random_state": 213396728,
}
...
if shap_enabled:
    ...
    train_sample = X_train.sample(n=min(100, X_train.shape[0]), random_state=213396728).fillna(mode)

    # Sample some rows from the validation set to explain. Increase the sample size for more thorough results.
    example = X_val.sample(n=min(100, X_val.shape[0]), random_state=213396728).fillna(mode)
...
displayHTML(f"<a href=#mlflow/experiments/630618801102421/runs/{ mlflow_run.info.run_id }/artifactPath/model> Link to model run page </a>")
